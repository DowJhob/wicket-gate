#include "db-query-processor.h"

db_query_processor::db_query_processor(QString conn_str, HttpSessionStore *sessionStore, QObject *parent) :
...
void db_query_processor::create_db_connect(QString conn_str)
{
...
bool db_query_processor::db_open()
{
...
QString db_query_processor::check_ticket(QString barcode)
{
...
void db_query_processor::service(QByteArray sessionId, HttpRequest &request, HttpResponse &response)
{
