...
LoginController::LoginController(QString conn_str, HttpSessionStore *sessionStore, QObject *parent) :
...
void LoginController::create_db_connect(QString conn_str)
{
...
int LoginController::check_pass(QString user, QByteArray pass)
{
